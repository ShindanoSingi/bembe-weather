...
const WeatherPage = ({ city, state, country, weatherData }) => {
  ...
  return weatherData.length < 1 ? (
    <div className="bg-[url('../src/images/sky.webp')] h-screen">
    ...
    <div className="bodyContainer bg-[url('../src/images/sky.webp')] h-screen">
      {/* Display the city */}
      <div className="text-center cityStateCountry text-blue-50">
        {" "}
        {city}, {state}, {country}{" "}
      </div>
      ...
      <div className="weatherContainer">
        {weekDays.map((day, index) => {
          ...
          if (index === 0 && index !== 7) {
            console.log(index)
            return (
              <div key={index} className="flex flex-col items-center mx-auto w-28 today1">
            ...
            if (index === 1) {
              return (
                <div key={index} className="flex flex-col items-center today2 w-28">
              ...
              return (
                <div key={index} className="flex flex-col items-center today3 w-28">
                  <p className="singleDayH1">{dayName}</p>
                  <p className="date">
                    {month}/{dayDate}/{year}
                  </p>
              ...
              return (
                <div key={index} className="flex flex-col items-center today4 w-28">
                  <p className="singleDayH1">{dayName}</p>
                  <p className="date">
                    {month}/{dayDate}/{year}
                  </p>
              ...
              return (
                <div key={index} className="flex flex-col items-center today5 w-28">
                  <p className="singleDayH1">{dayName}</p>
                  <p className="date">
                    {month}/{dayDate}/{year}
                  </p>
