      ...
      <div className="flex h-[30.5rem] xs:h-[23.5rem] weatherContainer">
        {weekDays.map((day, index) => {
          ...
          if (index === 0 && index !== 7) {
            console.log(index)
            return (
              <div key={index} className="fixed xs:relative flex flex-col items-center px-2 py-1 left-[33%] h-[13rem] xs:left-[10%] xs:flex-row xs:h-[6rem] xs:justify-baseline top-[3.5rem] place-content-center xs:w-[80vw] today1">
            ...
            if (index === 1) {
              return (
                <div key={index} className="flex xs:relative ml-1 flex-col items-center py-2 h-[13rem] xs:top-[10rem] top-[17rem]  today2 w-[24%]  relative justify-center mx-auto">
              ...
              return (
                <div key={index} className="flex flex-col items-center h-[13rem] day py-1 xs:top-[10rem] top-[17rem] today3 relative justify-center mx-auto w-[24%]">
                  <p className="text-lg singleDayH1">{dayName}</p>
                  <p className="text-sm date">
                    {month}/{dayDate}/{year}
                  </p>
