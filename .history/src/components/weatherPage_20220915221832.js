        ...
        {weekDays.map((day, index) => {
          ...
          if (index === 0 && index !== 7) {
            ...
            if (index === 1) {
              ...
              return (
                <div key={index} className="flex xs:h-[10rem] flex-col items-center h-[13rem] day justify-around py-2 md:text-4xl xs:top-[10rem] top-[17rem] today4 relative  mx-auto w-[24%]">
