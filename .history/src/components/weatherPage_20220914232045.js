      ...
      <div className="flex weatherContainer">
        {weekDays.map((day, index) => {
          ...
          if (index === 0 && index !== 7) {
            ...
            if (index === 1) {
              return (
                <div key={index} className="flex flex-col items-center today2 w-28  relative top-[20rem]">
              ...
              return (
                <div key={index} className="flex flex-col items-center day today3 w-28 relative top-[20rem]">
                  <p className="singleDayH1">{dayName}</p>
                  <p className="date">
                    {month}/{dayDate}/{year}
                  </p>
              ...
              return (
                <div key={index} className="flex flex-col items-center day today4 w-28 relative top-[20rem]">
                  <p className="singleDayH1">{dayName}</p>
                  <p className="date">
                    {month}/{dayDate}/{year}
                  </p>
              ...
              return (
                <div key={index} className="flex flex-col items-center day today5 w-28 relative top-[20rem]">
                  <p className="singleDayH1">{dayName}</p>
                  <p className="date">
                    {month}/{dayDate}/{year}
                  </p>
