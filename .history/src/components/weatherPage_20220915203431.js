        ...
        {weekDays.map((day, index) => {
          ...
          if (index === 0 && index !== 7) {
            ...
            if (index === 1) {
              ...
              return (
                <div key={index} className="flex flex-col items-center h-[13rem] day py-2 top-[17rem] today4 relative justify-center mx-auto w-[24%]">
                  <p className="singleDayH1">{dayName}</p>
                  <p className="date">
                    {month}/{dayDate}/{year}
                  </p>
              ...
              return (
                <div key={index} className="flex flex-col items-center day py-2 h-[13rem] top-[17rem] today5 w-[24%] mr-1 relative justify-center">
                  <p className="singleDayH1">{dayName}</p>
                  <p className="date">
                    {month}/{dayDate}/{year}
                  </p>
