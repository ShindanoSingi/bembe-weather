        ...
        {weekDays.map((day, index) => {
          ...
          if (index === 0 && index !== 7) {
            ...
            if (index === 1) {
              ...
              return (
                <div key={index} className="flex flex-col items-center h-[13rem] day py-2 xs:top-[10rem] top-[17rem] today4 relative justify-center mx-auto w-[24%]">
                  <p className="text-lg singleDayH1">{dayName}</p>
                  <p className="text-sm date">
                    {month}/{dayDate}/{year}
                  </p>
              ...
              return (
                <div key={index} className="flex flex-col items-center day py-2 h-[13rem] xs:top-[10rem] top-[17rem] today5 w-[24%] mr-1 relative justify-center">
                  <p className="text-lg singleDayH1">{dayName}</p>
                  <p className="text-sm date">
                    {month}/{dayDate}/{year}
                  </p>
