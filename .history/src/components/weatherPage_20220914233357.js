      ...
      <div className="flex weatherContainer">
        {weekDays.map((day, index) => {
          ...
          if (index === 0 && index !== 7) {
            ...
            if (index === 1) {
              return (
                <div key={index} className="flex flex-col items-center py-2 top-[15rem]  today2 w-28  relative justify-center mx-auto">
              ...
              return (
                <div key={index} className="flex flex-col items-center day py-2 top-[15rem] today3 w-28 relative justify-center mx-auto">
                  <p className="singleDayH1">{dayName}</p>
                  <p className="date">
                    {month}/{dayDate}/{year}
                  </p>
              ...
              return (
                <div key={index} className="flex flex-col items-center day py-2 top-[15rem] today4 w-28 relative justify-center mx-auto">
                  <p className="singleDayH1">{dayName}</p>
                  <p className="date">
                    {month}/{dayDate}/{year}
                  </p>
