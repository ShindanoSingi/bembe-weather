    ...
    <div className="mx-1">
      <form className="form-container" onSubmit={handleSubmit} d-flex>
        <div className="flex flex-col items-center gap-1 form-container">
          ...
          <input
          className="px-3 py-1 w-[98vw] md:text-3xl md:w-[70vw] text-center md:p-2 cityInput"
        ...
        {/* Country input */}
        <input
          className="px-3 md:text-3xl md:w-[70vw] text-center md:p-2 py-1 countryInput"
