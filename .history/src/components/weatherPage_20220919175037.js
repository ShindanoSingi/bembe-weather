      ...
      <div className="flex h-[30.5rem] xs:h-[20.5rem] md:h-[36rem] 2xl:px-[19%] lg:px-4 lg:h-[50rem] xl:h-[55rem] 2xl:h-[70vh] 3xl:flex 3xl:items-center 3xl:px-[9rem] 3xl:relative 3xl:top-16 3xl:w-[53vw]  xl:w-[98vw] mx-auto weatherContainer">
        {weekDays.map((day, index) => {
          ...
          if (index === 0 && index !== 7) {
            console.log(index)
            return (
              <div key={index} className="fixed 2xl:h-[16rem] xl:h-[25rem] xl:w-[15rem] lg:fixed flex flex-col 2xl:left-[43%] 2xl:top-[5rem] items-center px-2 xl:flex  lg:top-[6rem] py-1 left-[36%] h-[13rem] xs:left-[10%] xs:flex-row xs:h-[4.5rem] lg:left-[39%] lg:h-80 lg:w-48 xs:justify-baseline top-[3rem] md:left-[36vw] md:top-[4.5rem] md:w-[15rem] md:h-[18.5rem] place-content-center md:flex 3xl:left-0 3xl:top-[0rem] 3xl:h-[24rem] 2xl:w-[12rem] md:flex-col md:justify-around xs:w-[80vw] md:text-xl today1 3xl:relative 3xl:w-[13rem] 3xl:flex 3xl:justify-around">
