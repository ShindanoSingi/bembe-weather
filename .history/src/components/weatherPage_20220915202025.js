      ...
      <div className="flex h-[30rem] weatherContainer">
        {weekDays.map((day, index) => {
          ...
          if (index === 0 && index !== 7) {
            console.log(index)
            return (
              <div key={index} className="absolute flex flex-col items-center px-2 py-1 mx-auto left-[35%] h-[13rem] top-[3.5rem] place-content-center w-28 today1">
                <p className="single1 realtive top-2">{dayName}</p>
