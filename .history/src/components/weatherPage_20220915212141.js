...
const WeatherPage = ({ city, state, country, weatherData }) => {
  ...
  return weatherData.length < 1 ? (
    ...
    <div className="bodyContainer">
      {/* Display the city */}
      <div className="absolute top-0 w-screen text-xl text-center cityStateCountry text-blue-50">
        {" "}
        {city}, {state}, {country}{" "}
      </div>

      <div className="flex h-[28.5rem] xs:h-[28rem] weatherContainer">
        {weekDays.map((day, index) => {
          ...
          if (index === 0 && index !== 7) {
            console.log(index)
            return (
              <div key={index} className="fixed justify-center flex flex-col items-center px-2 py-1 mx-auto left-[33%] h-[12.5rem] xs:left-[10%] xs:flex-row xs:h-[6rem] xs:justify-baseline top-[3.5rem] place-content-center xs:w-[80vw] today1">
                <div className="xs:flex xs:items-center xs:flex-col">
                ...
                <img
                  ...
                  alt=""
                />
                <div className="items-center xs:flex xs:flex-col">
            ...
            if (index === 1) {
              return (
                <div key={index} className="flex ml-1 flex-col items-center py-2 h-[12rem] xs:top-[15rem] top-[16rem]  today2 w-[24%]  relative justify-center mx-auto">
              ...
              return (
                <div key={index} className="flex flex-col items-center h-[12rem] day py-1 xs:top-[15rem] top-[16rem] today3 relative justify-center mx-auto w-[24%]">
                  <p className="text-lg singleDayH1">{dayName}</p>
                  <p className="text-sm date">
                    {month}/{dayDate}/{year}
                  </p>
              ...
              return (
                <div key={index} className="flex flex-col items-center h-[12rem] day py-2 xs:top-[15rem] top-[16rem] today4 relative justify-center mx-auto w-[24%]">
                  <p className="text-lg singleDayH1">{dayName}</p>
                  <p className="text-sm date">
                    {month}/{dayDate}/{year}
                  </p>
              ...
              return (
                <div key={index} className="flex flex-col items-center day py-2 h-[12rem] xs:top-[15rem] top-[16rem] today5 w-[24%] mr-1 relative justify-center">
                  <p className="text-lg singleDayH1">{dayName}</p>
                  <p className="text-sm date">
                    {month}/{dayDate}/{year}
                  </p>
