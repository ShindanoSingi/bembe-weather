...
const WeatherPage = ({ city, state, country, weatherData }) => {
  ...
  return weatherData.length < 1 ? (
    ...
    <div className="bodyContainer">
      ...
      <div className="flex h-[30.5rem] xs:h-[20.5rem] md:h-[21rem] md:items-center 2xl:px-[19%] lg:px-4 lg:h-[50rem] xl:h-[30rem] md:mt-4 md:px-2 xl:mt-6 xl:px-2 2xl:h-[20rem] 2xl:my-4 3xl:flex 3xl:items-center 3xl:px-[9rem] xl:flex 2xl:items-center xl:items-center 3xl:relative 3xl:top-16 3xl:w-[53vw]  xl:w-[98vw] mx-auto weatherContainer">
