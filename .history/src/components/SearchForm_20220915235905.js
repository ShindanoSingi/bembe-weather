    ...
    <div className="mx-1 md:mb-4 lg:mb-8">
      <form className="form-container" onSubmit={handleSubmit} d-flex>
        ...
        />
          ...
          <button className="w-24 p-1 text-center py-1xl:text-3xl xl:w-52 xl:py-2 lg:p-2 lg:rounded-md lg:text-3xl lg:w-48 hover:bg-teal-600 md:w-48 md:text-3xl md:rounded-md md:p-2 submitButton" type="submit">
          Search
        </button>
        </div>
      </form>
