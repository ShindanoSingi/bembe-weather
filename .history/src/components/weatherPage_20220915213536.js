      ...
      <div className="flex h-[30.5rem] xs:h-[23.5rem] weatherContainer">
        {weekDays.map((day, index) => {
          ...
          if (index === 0 && index !== 7) {
            ...
            if (index === 1) {
              return (
                <div key={index} className="flex xs:relative ml-1 flex-col items-center py-2 h-[13rem] xs:h-[8rem] xs:top-[10rem] top-[17rem]  today2 w-[24%]  relative justify-center mx-auto">
