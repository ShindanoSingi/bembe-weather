      ...
      <div className="flex h-[30.5rem] xs:h-[20.5rem] weatherContainer">
        {weekDays.map((day, index) => {
          ...
          if (index === 0 && index !== 7) {
            console.log(index)
            return (
              <div key={index} className="fixed flex flex-col items-center px-2 py-1 left-[33%] h-[13rem] xs:left-[10%] xs:flex-row xs:h-[4.5rem] xs:justify-baseline top-[3rem] md:w-[15rem] md:h-[10rem] place-content-center xs:w-[80vw] md:text-xl today1">
            ...
            if (index === 1) {
              ...
              return (
                <div key={index} className="flex justify-around xs:h-[10rem] flex-col items-center day py-2 h-[13rem] md:text-3xl xs:top-[10rem] top-[17rem] today5 w-[24%] mr-1 relative">
                  <p className="text-lg singleDayH1 md:text-4xl">{dayName}</p>
                  <p className="text-sm date md:text-3xl">
                    {month}/{dayDate}/{year}
                  </p>
