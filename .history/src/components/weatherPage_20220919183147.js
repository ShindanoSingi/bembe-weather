...
const WeatherPage = ({ city, state, country, weatherData }) => {
  ...
  return weatherData.length < 1 ? (
    ...
    <div className="bodyContainer">
      ...
      <div className="flex h-[30.5rem] xs:h-[20.5rem] md:h-[20rem] md:items-center 2xl:px-[19%] lg:px-4 lg:h-[50rem] xl:h-[30rem] xl:mt-6 xl:px-2 2xl:h-[70vh] 3xl:flex 3xl:items-center 3xl:px-[9rem] xl:flex xl:items-center 3xl:relative 3xl:top-16 3xl:w-[53vw]  xl:w-[98vw] mx-auto weatherContainer">
