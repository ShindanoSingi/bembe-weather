  ...
  return (
    <div className="mx-1 md:mb-4 lg:mb-8">
      <form className="form-container" onSubmit={handleSubmit} d-flex>
        ...
        {/* Country input */}
        <input
          className="px-3 md:text-3xl lg:p-2 xl:text-3xl xl:w-[80vw] xl:py-2 lg:rounded-md lg:text-3xl lg:w-[80vw] md:w-[70vw] md:rounded-md text-center md:p-2 py-1 countryInput"
