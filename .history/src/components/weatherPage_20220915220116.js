  ...
  return weatherData.length < 1 ? (
    <div >
      ...
      <div className="px-2 w-[98vw] mt-4 md:p-4 message mx-[1vw]">
        <strong className="md:text-3xl">For US City: </strong><span  className="md:text-2xl">Enter the City, or City and State.</span><br></br>
        <strong  className="md:text-2xl">For Other Country's City: </strong><span  className="md:text-[36px]">Enter City, or City and Country's Code.</span>
      </div>
      <br></br>
      <br />
      <br />
