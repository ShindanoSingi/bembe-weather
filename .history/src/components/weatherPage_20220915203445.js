...
const WeatherPage = ({ city, state, country, weatherData }) => {
  ...
  return weatherData.length < 1 ? (
    ...
    <div className="bodyContainer">
      ...
      <div className="flex h-[30.5rem] weatherContainer">
        {weekDays.map((day, index) => {
          ...
          if (index === 0 && index !== 7) {
            console.log(index)
            return (
              <div key={index} className="absolute flex flex-col items-center px-2 py-1 mx-auto left-[35%] h-[12.5rem] top-[3rem] place-content-center w-28 today1">
            ...
            if (index === 1) {
              return (
                <div key={index} className="flex ml-1 flex-col items-center py-2 h-[13rem] top-[16rem]  today2 w-[24%]  relative justify-center mx-auto">
              ...
              return (
                <div key={index} className="flex flex-col items-center h-[13rem] day py-1 top-[16rem] today3 relative justify-center mx-auto w-[24%]">
                  <p className="singleDayH1">{dayName}</p>
                  <p className="date">
                    {month}/{dayDate}/{year}
                  </p>
              ...
              return (
                <div key={index} className="flex flex-col items-center h-[13rem] day py-2 top-[16rem] today4 relative justify-center mx-auto w-[24%]">
                  <p className="singleDayH1">{dayName}</p>
                  <p className="date">
                    {month}/{dayDate}/{year}
                  </p>
              ...
              return (
                <div key={index} className="flex flex-col items-center day py-2 h-[13rem] top-[16rem] today5 w-[24%] mr-1 relative justify-center">
                  <p className="singleDayH1">{dayName}</p>
                  <p className="date">
                    {month}/{dayDate}/{year}
                  </p>
