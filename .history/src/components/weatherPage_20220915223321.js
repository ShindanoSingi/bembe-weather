      ...
      <div className="flex h-[30.5rem] xs:h-[20.5rem] weatherContainer">
        {weekDays.map((day, index) => {
          ...
          if (index === 0 && index !== 7) {
            ...
            if (index === 1) {
              return (
                <div key={index} className="flex md:w-[15rem] md:h-[18rem]  justify-around xs:relative ml-1 flex-col items-center py-2 h-[13rem] xs:h-[10rem] xs:top-[10rem] md:relative md:top-[24rem] top-[17rem]  today2 w-[24%]  relative mx-auto">
              ...
              return (
                <div key={index} className="flex md:w-[15rem] md:h-[18rem]  xs:h-[10rem] justify-around flex-col items-center h-[13rem] day py-1 xs:top-[10rem] top-[17rem] md:relative md:top-[24rem] today3 relative mx-auto md:text-3xl w-[24%]">
                  <p className="text-lg singleDayH1 md:text-4xl">{dayName}</p>
                  <p className="text-sm date md:text-3xl">
                    {month}/{dayDate}/{year}
                  </p>
              ...
              return (
                <div key={index} className="flex md:w-[15rem] md:h-[18rem]  xs:h-[10rem] flex-col items-center h-[13rem] day justify-around py-2 md:text-3xl xs:top-[10rem] md:relative md:top-[24rem] top-[17rem] today4 relative  mx-auto w-[24%]">
                  <p className="text-lg singleDayH1 md:text-4xl">{dayName}</p>
                  <p className="text-sm date md:text-3xl">
                    {month}/{dayDate}/{year}
                  </p>
              ...
              return (
                <div key={index} className="flex md:w-[15rem] md:h-[18rem]  justify-around xs:h-[10rem] flex-col items-center day py-2 h-[13rem] md:text-3xl xs:top-[10rem] md:relative md:top-[24rem] top-[17rem] today5 w-[24%] mr-1 relative">
                  <p className="text-lg singleDayH1 md:text-4xl">{dayName}</p>
                  <p className="text-sm date md:text-3xl">
                    {month}/{dayDate}/{year}
                  </p>
