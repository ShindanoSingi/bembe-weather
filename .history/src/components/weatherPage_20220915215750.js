  ...
  return weatherData.length < 1 ? (
    <div >
      ...
      <div className="px-2 w-[98vw] mt-4 message mx-[1vw]">
        <strong className="md:text-2xl">For US City: </strong><span>Enter the City, or City and State.</span><br></br>
        <strong  className="md:text-2xl">For Other Country's City: </strong><span>Enter City, or City and Country's Code.</span>
      </div>
      <br></br>
      <br />
      <br />
