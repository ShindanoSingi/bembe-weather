        ...
        {weekDays.map((day, index) => {
          ...
          if (index === 0 && index !== 7) {
            ...
            if (index === 1) {
              ...
              return (
                <div key={index} className="flex xs:h-[10rem] justify-around flex-col items-center h-[13rem] day py-1 xs:top-[10rem] top-[17rem] today3 relative justify-center mx-auto w-[24%]">
                  <p className="text-lg singleDayH1">{dayName}</p>
                  <p className="text-sm date">
                    {month}/{dayDate}/{year}
                  </p>
