      ...
      <div className="flex h-[30.5rem] weatherContainer">
        {weekDays.map((day, index) => {
          ...
          if (index === 0 && index !== 7) {
            ...
            if (index === 1) {
              return (
                <div key={index} className="flex ml-1 flex-col items-center py-2 h-[13rem] top-[17rem]  today2 w-[24%]  relative justify-center mx-auto">
              ...
              return (
                <div key={index} className="flex flex-col items-center h-[13rem] day py-1 top-[17rem] today3 relative justify-center mx-auto w-[24%]">
                  <p className="singleDayH1">{dayName}</p>
                  <p className="date">
                    {month}/{dayDate}/{year}
                  </p>
