      ...
      <div className="flex h-[28.5rem] weatherContainer">
        {weekDays.map((day, index) => {
          ...
          if (index === 0 && index !== 7) {
            ...
            if (index === 1) {
              return (
                <div key={index} className="flex ml-1 flex-col items-center py-2 h-[12rem] top-[15rem]  today2 w-[24%]  relative justify-center mx-auto">
              ...
              return (
                <div key={index} className="flex flex-col items-center h-[12rem] day py-1 top-[15rem] today3 relative justify-center mx-auto w-[24%]">
                  <p className="text-lg singleDayH1">{dayName}</p>
                  <p className="text-sm date">
                    {month}/{dayDate}/{year}
                  </p>
              ...
              return (
                <div key={index} className="flex flex-col items-center h-[12rem] day py-2 top-[15rem] today4 relative justify-center mx-auto w-[24%]">
                  <p className="text-lg singleDayH1">{dayName}</p>
                  <p className="text-sm date">
                    {month}/{dayDate}/{year}
                  </p>
