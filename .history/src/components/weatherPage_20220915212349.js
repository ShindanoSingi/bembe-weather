      ...
      <div className="flex h-[28.5rem] xs:h-[28rem] weatherContainer">
        {weekDays.map((day, index) => {
          ...
          if (index === 0 && index !== 7) {
            console.log(index)
            return (
              <div key={index} className="fixed flex flex-col items-center px-2 py-1 left-[33%] h-[12.5rem] xs:left-[10%] xs:flex-row xs:h-[6rem] xs:justify-baseline top-[3.5rem] place-content-center xs:w-[80vw] today1">
                <div className="flex items-center xs:flex xs:items-center xs:flex-col">
