      ...
      <div className="flex h-[30.5rem] xs:h-[20.5rem] weatherContainer">
        {weekDays.map((day, index) => {
          ...
          if (index === 0 && index !== 7) {
            console.log(index)
            return (
              <div key={index} className="fixed flex flex-col items-center px-2 py-1 left-[33%] h-[13rem] xs:left-[10%] xs:flex-row xs:h-[4.5rem] xs:justify-baseline top-[3rem] md:top-8 md:w-[15rem] md:h-[18rem] place-content-center xs:w-[80vw] md:text-xl today1">
