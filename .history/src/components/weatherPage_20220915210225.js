      ...
      <div className="flex h-[28.5rem] weatherContainer">
        {weekDays.map((day, index) => {
          ...
          if (index === 0 && index !== 7) {
            console.log(index)
            return (
              <div key={index} className="absolute flex flex-col items-center px-2 py-1 mx-auto left-[33%] h-[12.5rem] xs:left-[5%] xs:h-[6rem] top-[3.5rem] place-content-center xs:w-[80vw] today1">
