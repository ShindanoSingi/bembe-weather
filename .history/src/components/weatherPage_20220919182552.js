        ...
        {weekDays.map((day, index) => {
          ...
          if (index === 0 && index !== 7) {
            ...
            if (index === 1) {
              ...
              return (
                  <div key={index} className="flex 3xl:h-[20rem] 3xl:text-3xl xl:top-[0rem] xl:relative2xl:h-[16rem] xl:h-[25rem] xl:w-[13rem] 2xl:w-[12rem] 2xl:relative 2xl:top-[55%] lg:relative lg:top-[28rem] lg:h-80 lg:w-48 md:w-[11.8rem] md:h-[18rem]  xs:h-[10rem] 3xl:w-[13rem] flex-col items-center h-[13rem] day justify-around py-2 md:text-3xl 3xl:top-[0rem]  xs:top-[10rem] md:relative md:top-[23.5rem] top-[17rem] today4 relative  mx-auto w-[24%]">
