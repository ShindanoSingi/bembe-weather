...
const WeatherPage = ({ city, state, country, weatherData }) => {
  ...
  return weatherData.length < 1 ? (
    ...
    <div className="bodyContainer">
      ...
      <div className="flex h-[30.5rem] xs:h-[20.5rem] md:h-[21rem] md:items-center 2xl:px-[19%] lg:px-4 lg:h-[50rem] xl:h-[30rem] md:mt-4 md:px-2 xl:mt-6 xl:px-2 2xl:h-[70vh] 3xl:flex 3xl:items-center 3xl:px-[9rem] xl:flex 2xl:items-center xl:items-center 3xl:relative 3xl:top-16 3xl:w-[53vw]  xl:w-[98vw] mx-auto weatherContainer">
        {weekDays.map((day, index) => {
          ...
          if (index === 0 && index !== 7) {
            console.log(index)
            return (
              <div key={index} className="fixed 2xl:h-[19rem] 2xl:relative xl:w-[15rem] lg:fixed flex flex-col 2xl:left-[0%] 2xl:top-[0rem] xl:h-[28rem] md:relative xl:left-0 xl:top-[0rem] xl:relative items-center px-2 xl:flex  xl:justify-around lg:top-[6rem] py-1 left-[36%] h-[13rem] xs:left-[10%] xs:flex-row xs:h-[4.5rem] lg:left-[39%] lg:h-80 lg:w-48 xs:justify-baseline top-[5rem] md:left-0 md:top-[0rem] md:w-[10rem] md:h-[19.5rem] place-content-center md:flex 3xl:left-0 3xl:top-[0rem] 3xl:h-[24rem] 2xl:w-[12rem] md:flex-col md:justify-around xs:w-[80vw] md:text-md today1 3xl:relative 3xl:w-[13rem] 3xl:flex 3xl:justify-around">
            ...
            if (index === 1) {
              return (
                <div key={index} className="flex 3xl:w-[13rem] xl:h-[25rem] 2xl:relative 2xl:top-[0%] xl:w-[13rem] 2xl:h-[18rem] lg:h-80 3xl:h-[20rem] md:relative md:top-0 lg:w-48 md:w-[10rem] 2xl:w-[12rem] md:h-[18rem] xl:top-[0rem] xl:relative justify-around lg:relative lg:top-[28rem] xs:relative ml-1 flex-col items-center py-2 h-[13rem] xs:h-[10rem] xs:top-[10rem] 3xl:top-[0rem] top-[17rem]  today2 w-[24%]  relative mx-auto">
              ...
              return (
                  <div key={index} className="flex 3xl:h-[20rem] 3xl:text-3xl xl:top-[0rem] xl:relative 2xl:h-[18rem] xl:h-[25rem] xl:w-[13rem] 2xl:w-[12rem] 2xl:relative 2xl:top-[0%] lg:relative lg:top-[28rem] lg:h-80 lg:w-48 md:w-[10rem] md:h-[18rem]  xs:h-[10rem] 3xl:w-[13rem] flex-col items-center h-[13rem] day justify-around py-2 md:text-3xl 3xl:top-[0rem]  xs:top-[10rem] md:relative md:top-0 top-[17rem] today4 relative  mx-auto w-[24%]">
              ...
              return (
                <div key={index} className="flex 3xl:h-[20rem] 2xl:relative xl:top-[0rem] xl:relative 2xl:top-[0%] 3xl:w-[13rem] 2xl:h-[18rem] xl:h-[25rem] xl:w-[13rem] 2xl:w-[12rem] lg:relative lg:top-[28rem] lg:h-80 lg:w-48 md:w-[10rem] md:h-[18rem] 3xl:text-3xl xs:h-[10rem] flex-col items-center h-[13rem] day justify-around py-2 3xl:top-[0rem] md:text-3xl xs:top-[10rem] md:relative md:top-[0rem] top-[17rem] today4 relative  mx-auto w-[24%]">
                  <p className="text-lg singleDayH1 xl:text-4xl md:text-3xl lg:text-4xl 2xl:text-3xl 3xl:text-3xl">{dayName}</p>
                  <p className="text-sm date md:text-xl xl:text-2xl lg:text-3xl 2xl:text-xl 3xl:text-2xl">
                    {month}/{dayDate}/{year}
                  </p>
              ...
              return (
                <div key={index} className="flex 3xl:h-[20rem] 3xl:w-[13rem] xl:top-[0rem] xl:relative2xl:relative 2xl:top-[0%] 2xl:h-[18rem] xl:h-[25rem] xl:w-[13rem] 2xl:w-[12rem] lg:h-80 lg:w-48 lg:relative lg:top-[28rem]  md:w-[10rem] md:h-[18rem] 3xl:text-3xl justify-around xs:h-[10rem] flex-col items-center day py-2 h-[13rem] md:text-3xl 3xl:top-[0rem] xs:top-[10rem] md:relative md:top-[0rem] top-[17rem] today5 w-[24%] mr-1 relative">
