...
const WeatherPage = ({ city, state, country, weatherData }) => {
  ...
  return weatherData.length < 1 ? (
    ...
    <div className="bodyContainer">
      ...
      <div className="flex h-[30.5rem] xs:h-[20.5rem] md:h-[36rem] 2xl:px-[19%] lg:px-4 lg:h-[50rem] xl:px-20 xl:h-[62rem] 2xl:h-[70vh] 3xl:flex 3xl:items-center 3xl:px-[9rem] 3xl:relative 3xl:top-16 3xl:w-[53vw]  xl:w-[50vw] mx-auto weatherContainer">
