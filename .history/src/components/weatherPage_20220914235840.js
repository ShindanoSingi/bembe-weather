...
const WeatherPage = ({ city, state, country, weatherData }) => {
  ...
  return weatherData.length < 1 ? (
    ...
    <div className="bg-black bodyContainer">
      {/* Display the city */}
      ...
      <div className="flex h-[30rem] weatherContainer">
        {weekDays.map((day, index) => {
          ...
          if (index === 0 && index !== 7) {
            console.log(index)
            return (
              <div key={index} className="absolute flex flex-col items-center px-2 py-1 mx-auto left-[35%] top-[3.5rem] place-content-center w-28 today1">
            ...
            if (index === 1) {
              return (
                <div key={index} className="flex flex-col items-center py-2 h-[13rem] top-[18.5rem]  today2 w-28  relative justify-center mx-auto">
              ...
              return (
                <div key={index} className="flex flex-col items-center h-[13rem] day py-2 top-[18.5rem] today3 w-28 relative justify-center mx-auto">
                  <p className="singleDayH1">{dayName}</p>
                  <p className="date">
                    {month}/{dayDate}/{year}
                  </p>
              ...
              return (
                <div key={index} className="flex flex-col items-center h-[13rem] day py-2 top-[18.5rem] today4 w-28 relative justify-center mx-auto">
                  <p className="singleDayH1">{dayName}</p>
                  <p className="date">
                    {month}/{dayDate}/{year}
                  </p>
              ...
              return (
                <div key={index} className="flex flex-col items-center day py-2 h-[13rem] top-[18.5rem] today5 w-28 relative justify-center">
                  <p className="singleDayH1">{dayName}</p>
                  <p className="date">
                    {month}/{dayDate}/{year}
                  </p>
