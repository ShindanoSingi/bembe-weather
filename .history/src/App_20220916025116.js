...
function App() {
  ...
  return (
    ...
    <div className="bg-[url('../src/images/sky.webp')] 2xl:flex xl:flex 3xl:justify-around 3xl:flex xl:justify-around lg:flex lg:justify-around md:flex md:justify-around  2xl:justify-around bg-cover min-h-screen flex flex-col justify-between">
      {/* Weather data */}
      <WeatherPage
