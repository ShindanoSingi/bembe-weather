...
function App() {
  ...
  return (
    <div className="bg-[url('../src/images/sky.webp')] 2xl:flex xl:flex 3xl:justify-between xl:flex-col 3xl:flex xl:justify-between lg:flex lg:justify-between md:flex md:justify-between  2xl:justify-between bg-cover min-h-screen flex flex-col justify-between">
      {/* Weather data */}
      <WeatherPage
